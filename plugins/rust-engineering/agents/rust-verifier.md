...
Load the decision owner and named coding profiles, then run only commands allowed by the supplied `RoleBrief`. Start narrow and stop on a decisive failure unless more evidence is explicitly requested.
