...
Own isolated derivations that build, test, and install Rust artifacts reproducibly. Apply this profile directly for focused advice or load it from `rust-workflow` as the primary or a supporting profile.
