...
This guide is the detailed policy for `nix-review`. It synthesizes the craft Nix review rules and the flake, dev-environment, packaging, and NixOS profile contracts; it is adapted for a dual-host workflow rather than copied as an upstream transcript.
