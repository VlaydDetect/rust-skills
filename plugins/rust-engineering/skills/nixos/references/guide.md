...
This guide is the detailed policy for `nixos`. It synthesizes the craft NixOS and Home Manager guidance covering module options, merge behavior, services, secrets, and deployment; it is adapted for a dual-host workflow rather than copied as an upstream transcript.
