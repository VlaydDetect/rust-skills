...
> Adapted from Actionbook `rust-refactor-helper`. `refactoring` owns edits; navigation and LSP operations only build the impact map and never prove behavioral preservation by themselves.
