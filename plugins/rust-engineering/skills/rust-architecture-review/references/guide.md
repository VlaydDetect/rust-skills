...
This guide is the detailed policy for `rust-architecture-review`. It consolidates the decisions, workflows, and examples required by this profile in the dual-host plugin.
