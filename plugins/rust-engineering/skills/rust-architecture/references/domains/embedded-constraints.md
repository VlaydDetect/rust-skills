> Retained embedded constraint map. no_std, no heap, real-time behavior, critical sections, RTIC, Embassy, and heapless are conditional on the target and hardware contract; do not auto-read project files or select crates from this reference.
