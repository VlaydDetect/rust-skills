# Huiali Cache Protocol

> Product adaptation of `skills/rust-cache/SKILL.md` at revision `947bf77509d9b421035037e983da6662d08cbb8e`. The source workflow is retained below; product routing and current-project constraints override source-wide preferences.
...
<!-- huiali-source: skills/rust-cache/SKILL.md#rust-block-1; sha256=ec925764bc3bbcdbcbc8205befc0e88f0d4219d38e04b17530b44fda72cf9bbf -->
...
<!-- huiali-source: skills/rust-cache/SKILL.md#rust-block-2; sha256=366e70ef56aa60cf85cfe18341682402e832291d11e45aa418ce02dbfaea90c5 -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
...
<!-- huiali-source: skills/rust-cache/SKILL.md#rust-block-3; sha256=4a631499d0b8625bd85aea8310a516eb17417203b9e4e0933367e710c7e5efde -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
...
<!-- huiali-source: skills/rust-cache/SKILL.md#rust-block-4; sha256=8b38de9952cf4345480162a81530d6063e5f2889e634e939dc49b4e0d360300f -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
impl CacheManager {
...
<!-- huiali-source: skills/rust-cache/SKILL.md#rust-block-5; sha256=01cb6ce442b843fff7bf86e88b0e08164e4035a9370470883b21d9e9f788119f -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
use rand::Rng;
...
<!-- huiali-source: skills/rust-cache/SKILL.md#rust-block-6; sha256=c9b683a7d857c346be301a5fd599ffed05cedb619671bef15228b6f567620343 -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
// ❌ Bad: no protection
...
<!-- huiali-source: skills/rust-cache/SKILL.md#rust-block-7; sha256=024dfbe30a79fe5c2a5fe6f7a78700358e9133dd13eaaed559e0205f570772d9 -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
// ❌ Bad: no TTL
...
<!-- huiali-source: skills/rust-cache/SKILL.md#rust-block-8; sha256=884f944b541ff317f07156541fe34f00762c0de68105e7f242d8a4551786190d -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
...
<!-- huiali-source: skills/rust-cache/SKILL_EN.md#rust-block-1; sha256=d89470775fdce593a2e6388bc18da7177e9bd818f2ae4cd986ed1dd7c697df42 -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
...
<!-- huiali-source: skills/rust-cache/SKILL_ZH.md#rust-block-1; sha256=01b02b93a37d013fd2c6002806ff754a8a49a5401dda2f909a25219e64b5deea -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
//! 缓存管理器实现
//!
...
<!-- huiali-source: skills/rust-cache/SKILL_ZH.md#rust-block-2; sha256=5b5d65dfff046499dff8b65b79f0de6d42fee128845e76383ca0fd5fb5e8fafa -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
/// 缓存键生成器
///
...
<!-- huiali-source: skills/rust-cache/SKILL_ZH.md#rust-block-3; sha256=a451a3d3a1c73bfc31d36d52224d376d1c5773609d9681f495cbdb05eb2b24b0 -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
impl CacheManager {
    /// 批量删除缓存（支持模式匹配）
...
<!-- huiali-source: skills/rust-cache/SKILL_ZH.md#rust-block-4; sha256=f4e22ca4ad3976b611d652cbef38239a66286039ed079b9aba680c68f7394a9f -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
/// 缓存配置
#[derive(Debug, Clone)]
...
<!-- huiali-source: skills/rust-cache/SKILL_ZH.md#rust-block-5; sha256=a64cd0a7af68ecbf58facf9a52a9ed2ea8a9c0b18d5920815d2a896a5e93c5d0 -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
/// TTL 分层设计
pub struct CacheTTL {
...
<!-- huiali-source: skills/rust-cache/SKILL_ZH.md#rust-block-6; sha256=b500b50445f7b888eafe8221cccfb72959c7c14842d33eb8ec2b05208e93f49d -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
/// 缓存穿透防护
pub struct CacheBreaker<K, T> {
...
<!-- huiali-source: skills/rust-cache/SKILL_ZH.md#rust-block-7; sha256=a8c1c8680982f30d794958958d87b6432bd57d7a8aeca7ac1a5f50621738badf -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
/// 缓存雪崩防护：随机 TTL 抖动
fn calculate_jitter_ttl(base_ttl: u64) -> u64 {
...
<!-- huiali-source: skills/rust-cache/SKILL_ZH.md#rust-block-8; sha256=db62f69be362f08cd7523e7ae33d78d9cc78727066a63338d1122e2a60621a34 -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
