# Huiali Middleware Protocol

> Product adaptation of `skills/rust-middleware/SKILL.md` at revision `947bf77509d9b421035037e983da6662d08cbb8e`. The source workflow is retained below; product routing and current-project constraints override source-wide preferences.

## Product routing and baseline

- Primary owner: `$rust-architecture`.
- Supporting profiles when needed: `$rust-concurrency`, `$rust-observability`.
- Scope retained: Request pipelines, ordering, short-circuiting, context propagation, cancellation, retries, timeouts, and cross-cutting policy.
- Baseline correction: Make middleware order and ownership explicit; do not hide domain behavior, duplicate retries, or hold request resources beyond their lifecycle.
...
<!-- huiali-source: skills/rust-middleware/SKILL.md#rust-block-1; sha256=9f07ad2ded5da6205c53016e7b1d92f13eaf909369940ceaf08130cd50bbf54f -->
...
<!-- huiali-source: skills/rust-middleware/SKILL.md#rust-block-2; sha256=e69b3295d2b8c3ecf8d742dbc3252353602c149a4389edd5de0be8a741c350c7 -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
use actix_cors::Cors;
...
<!-- huiali-source: skills/rust-middleware/SKILL.md#rust-block-3; sha256=1e19d196ea45eb36178cd03920eb38dc0956398636530b88a7d4bae008884d5c -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
use actix_web::{
    dev::{forward_ready, Service, ServiceRequest, ServiceResponse, Transform},
...
<!-- huiali-source: skills/rust-middleware/SKILL.md#rust-block-4; sha256=32b4b28e7dd6ee4b622203a10f03fa5474f22b583499ca0003cdcb5d836da46a -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
use axum::{
    extract::Request,
...
<!-- huiali-source: skills/rust-middleware/SKILL.md#rust-block-5; sha256=260f31f0f349764d51a9ec4de9e79888b943c0549b97aeeb50c2f07013bb9592 -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
...
<!-- huiali-source: skills/rust-middleware/SKILL.md#rust-block-6; sha256=e0a1739c33fefb51f100ddc98067cc74be49991c6272de1bfeae02850304a002 -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
...
<!-- huiali-source: skills/rust-middleware/SKILL.md#rust-block-7; sha256=5900bdc291f0b7baeed5ce103333cd64a20caec6717567af4b4dc0194c5f3d5b -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
...
<!-- huiali-source: skills/rust-middleware/SKILL.md#rust-block-8; sha256=f240ec957148d7aa8a28268527296db4426b391e6c2763d7c405f815117df881 -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
...
<!-- huiali-source: skills/rust-middleware/SKILL_ZH.md#rust-block-1; sha256=2823f81e650a8961222af0bc70cb244d0f9d409372c13a47dfad4781083497db -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
use actix_web::{
    dev::{forward_ready, Service, ServiceRequest, ServiceResponse, Transform},
...
<!-- huiali-source: skills/rust-middleware/SKILL_ZH.md#rust-block-2; sha256=bf4af370361d4acdeea34f4db2c0792e17795fb0af8c02abb86d5adca681c890 -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
use actix_cors::Cors;
...
<!-- huiali-source: skills/rust-middleware/SKILL_ZH.md#rust-block-3; sha256=198344c6ead28c19b5d7f0a0ec6ba8f4520cdac6023ec688e3f9f33948726ca4 -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
