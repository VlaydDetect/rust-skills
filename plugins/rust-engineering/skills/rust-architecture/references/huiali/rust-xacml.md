# Huiali Xacml Protocol

> Product adaptation of `skills/rust-xacml/SKILL.md` at revision `947bf77509d9b421035037e983da6662d08cbb8e`. The source workflow is retained below; product routing and current-project constraints override source-wide preferences.
...
<!-- huiali-source: skills/rust-xacml/SKILL.md#rust-block-1; sha256=cfbb86a14fbdcd483c91dc4a4674d9aad9d58e736946f01c6ea336c22fc53010 -->
...
<!-- huiali-source: skills/rust-xacml/SKILL.md#rust-block-2; sha256=d8cd7d5de96e385d2271eb1efd2a1fbb70f0f0b83784fd1e28578905356d0350 -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
//! RBAC 权限检查
...
<!-- huiali-source: skills/rust-xacml/SKILL.md#rust-block-3; sha256=520748eeba60dfb4455a1f7d4c3ec1e390374e101ba64000798e78f4912b0fa7 -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
//! 策略缓存
...
<!-- huiali-source: skills/rust-xacml/SKILL.md#rust-block-4; sha256=d6043b2e3d89b4b3659160e56067f5322fa30b286bf95eed2f47fea962cdd616 -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
//! 策略构建器
