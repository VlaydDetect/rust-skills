...
Actionbook's `/guideline` intent maps to the existing addressable rulebook:
...
Actionbook P/G labels do not override repository policy. Use the [crosswalk](crosswalk.md) for every source summary item and lint mapping.
