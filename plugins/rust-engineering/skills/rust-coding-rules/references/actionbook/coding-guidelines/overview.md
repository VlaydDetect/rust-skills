...
> Adapted from Actionbook `coding-guidelines`. Each item is a candidate mapped through the canonical rulebook or owner profile; project contracts override generic style guidance.
