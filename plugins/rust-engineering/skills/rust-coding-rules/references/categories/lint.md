...
| [`lint-clippy-nursery-selected`](../rules/lint-clippy-nursery-selected.md) | `canonical` | `rust-style-clippy` | Enable high-value `clippy::nursery` lints selectively, not the whole group |
| [`lint-deny-correctness`](../rules/lint-deny-correctness.md) | `canonical` | `rust-style-clippy` | `#![deny(clippy::correctness)]` |
| [`lint-missing-docs`](../rules/lint-missing-docs.md) | `canonical` | `rust-style-clippy` | Warn on missing documentation for public items |
| [`lint-pedantic-selective`](../rules/lint-pedantic-selective.md) | `canonical` | `rust-style-clippy` | Enable clippy::pedantic selectively |
| [`lint-rustfmt-check`](../rules/lint-rustfmt-check.md) | `canonical` | `rust-style-clippy` | Run cargo fmt --check in CI |
| [`lint-unsafe-doc`](../rules/lint-unsafe-doc.md) | `conditional` | `rust-style-clippy` | Require documentation for unsafe blocks |
| [`lint-warn-complexity`](../rules/lint-warn-complexity.md) | `canonical` | `rust-style-clippy` | Enable clippy::complexity for simpler code |
| [`lint-warn-perf`](../rules/lint-warn-perf.md) | `canonical` | `rust-style-clippy` | Enable clippy::perf for performance improvements |
| [`lint-warn-style`](../rules/lint-warn-style.md) | `canonical` | `rust-style-clippy` | Enable clippy::style for idiomatic code |
| [`lint-warn-suspicious`](../rules/lint-warn-suspicious.md) | `canonical` | `rust-style-clippy` | Enable clippy::suspicious for likely bugs |
| [`lint-workspace-lints`](../rules/lint-workspace-lints.md) | `canonical` | `rust-style-clippy` | Configure lints at workspace level for consistent enforcement |
