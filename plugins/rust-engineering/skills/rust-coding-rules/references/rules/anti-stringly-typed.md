...
<!-- rust-example: fragment; missing: surrounding domain types, functions, imports, and crate context referenced by the Parsing Strings to Types illustration -->
```rust
use std::str::FromStr;
...
<!-- rust-example: fragment; missing: surrounding domain types, functions, imports, and crate context referenced by the Error Messages illustration -->
```rust
#[derive(Debug, Clone, Copy)]
enum Color {
    Red,
