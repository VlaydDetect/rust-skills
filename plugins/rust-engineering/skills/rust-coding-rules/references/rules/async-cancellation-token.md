...
- External crates referenced by the source (`tokio-util`, `tokio`) must already be accepted by the project or be approved before addition.
...
<!-- rust-example: fragment; missing: surrounding domain types, functions, imports, and crate context referenced by the CancellationToken API illustration -->
```rust
use tokio_util::sync::CancellationToken;
...
<!-- rust-example: fragment; missing: surrounding domain types, functions, imports, and crate context referenced by the Hierarchical Cancellation illustration -->
```rust
...
<!-- rust-example: fragment; missing: surrounding domain types, functions, imports, and crate context referenced by the Graceful Shutdown Pattern illustration -->
```rust
use tokio::signal;
...
<!-- rust-example: fragment; missing: surrounding domain types, functions, imports, and crate context referenced by the DropGuard Pattern illustration -->
```rust
use tokio_util::sync::CancellationToken;
