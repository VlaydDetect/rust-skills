...
<!-- rust-example: fragment; missing: surrounding domain types, functions, imports, and crate context referenced by the watch Semantics illustration -->
```rust
use tokio::sync::watch;
...
<!-- rust-example: fragment; missing: surrounding domain types, functions, imports, and crate context referenced by the Configuration Reload Pattern illustration -->
```rust
use tokio::sync::watch;
use std::sync::Arc;
...
<!-- rust-example: fragment; missing: surrounding domain types, functions, imports, and crate context referenced by the State Machine Updates illustration -->
```rust
...
<!-- rust-example: fragment; missing: surrounding domain types, functions, imports, and crate context referenced by the Borrow vs Clone illustration -->
```rust
use tokio::sync::watch;
