...
Use this context-sensitive Rust decision when its premise is established: Accept `impl AsMut<T>` for flexible mutable borrowed inputs instead of concrete mutable references.
