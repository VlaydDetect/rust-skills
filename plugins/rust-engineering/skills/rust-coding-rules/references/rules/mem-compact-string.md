...
- External crates referenced by the source (`smallvec`, `bytes`, `compact_str`, `smartstring`) must already be accepted by the project or be approved before addition.
...
<!-- rust-example: fragment; missing: surrounding domain types, functions, imports, and crate context referenced by the compactstr illustration -->
```rust
use compact_str::CompactString;
...
<!-- rust-example: fragment; missing: surrounding domain types, functions, imports, and crate context referenced by the smartstring illustration -->
```rust
...
<!-- rust-example: fragment; missing: surrounding domain types, functions, imports, and crate context referenced by the ecow (copy-on-write) illustration -->
```rust
use ecow::EcoString;
...
<!-- rust-example: fragment; missing: surrounding domain types, functions, imports, and crate context referenced by the Memory Comparison illustration -->
```rust
use std::mem::size_of;
