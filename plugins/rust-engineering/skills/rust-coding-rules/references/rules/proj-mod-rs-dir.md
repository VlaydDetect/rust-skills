...
<!-- rust-example: fragment; missing: surrounding domain types, functions, imports, and crate context referenced by the Style 1: mod.rs (Recommended for larger modules) illustration -->
```rust
// src/lib.rs
...
<!-- rust-example: fragment; missing: surrounding domain types, functions, imports, and crate context referenced by the Style 2: Adjacent file (Recommended for smaller modules) illustration -->
```rust
// src/lib.rs
...
<!-- rust-example: fragment; missing: surrounding domain types, functions, imports, and crate context referenced by the Example: Complex Module illustration -->
```rust
// src/database/mod.rs
mod connection;
mod migrations;
...
<!-- rust-example: fragment; missing: surrounding domain types, functions, imports, and crate context referenced by the Consistency Rule illustration -->
```rust
