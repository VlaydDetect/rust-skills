...
<!-- rust-example: fragment; missing: surrounding domain types, functions, imports, and crate context referenced by the mockall Crate illustration -->
```rust
use mockall::*;
...
<!-- rust-example: fragment; missing: surrounding domain types, functions, imports, and crate context referenced by the Testing Error Paths illustration -->
```rust
#[async_trait]
...
<!-- rust-example: fragment; missing: surrounding domain types, functions, imports, and crate context referenced by the Dynamic Dispatch Alternative illustration -->
```rust
