...
> Adapted from Actionbook `m07-concurrency`. Choose threads, runtimes, locks, and channels from topology, cancellation, backpressure, poisoning, fairness, MSRV, and dependency constraints.
