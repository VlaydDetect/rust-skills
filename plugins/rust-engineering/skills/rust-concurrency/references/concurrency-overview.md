...
> Choose threads, runtimes, locks, and channels from topology, cancellation, backpressure, poisoning, fairness, MSRV, and dependency constraints.
...
| transactions, payments, trading, payment | **domain-fintech** | Audit + thread safety |
