# Huiali Async Pattern Protocol

> Product adaptation of `skills/rust-async-pattern/SKILL.md` at revision `947bf77509d9b421035037e983da6662d08cbb8e`. The source workflow is retained below; product routing and current-project constraints override source-wide preferences.

## Product routing and baseline

- Primary owner: `$rust-concurrency`.
- Supporting profiles when needed: `$rust-architecture`, `$rust-ownership`.
- Scope retained: Async architecture choices, arenas, actors, owned snapshots, task topology, cancellation, and lifetime containment.
- Baseline correction: Prefer the smallest ownership shape that makes task lifetime explicit; do not introduce actors, arenas, boxed futures, or detached tasks merely to silence a borrow error.
...
<!-- huiali-source: skills/rust-async-pattern/SKILL.md#rust-block-1; sha256=fef1fb7729d74d94785b3ab9ee5580af58b7dfe3a7d97e5b65160259dc6e24b8 -->
...
<!-- huiali-source: skills/rust-async-pattern/SKILL.md#rust-block-2; sha256=52558380787e450538176b71da4b0232f972ae785b9a83848cb51600bfb5d54c -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
use std::sync::Arc;
...
<!-- huiali-source: skills/rust-async-pattern/SKILL.md#rust-block-3; sha256=b9f05b91b93b2090dd1c1660e5e0a615d53b4fa5541a5d8e54ef6acdbaa33c73 -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
use tokio::sync::mpsc;
...
<!-- huiali-source: skills/rust-async-pattern/SKILL.md#rust-block-4; sha256=a772c990b54de81fbed76eab3a0687648288e50373dbb745b03c9a9d8e13fdba -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
use bytes::Bytes;
...
<!-- huiali-source: skills/rust-async-pattern/SKILL.md#rust-block-5; sha256=a26cb2fd48dceceb321d91f5f5e58d7214bc12615e207d6e8ab0c75e9a5ea587 -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
...
<!-- huiali-source: skills/rust-async-pattern/SKILL.md#rust-block-6; sha256=3cfe2e67ba030603dc5b2c53436347e29b4dd326b6a532d2ad5c565fa17f8d10 -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
...
<!-- huiali-source: skills/rust-async-pattern/SKILL.md#rust-block-7; sha256=a6700f8cc2ccdfec9b620403ccd35f865e22462907d4d97adc90a13983b618bc -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
...
<!-- huiali-source: skills/rust-async-pattern/SKILL.md#rust-block-8; sha256=5c5f13587c050755af0e1cd8c1a05a402e60e80af2dc068e675523a6b8659dff -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
...
<!-- huiali-source: skills/rust-async-pattern/SKILL_EN.md#rust-block-1; sha256=34361314ab923febc351f33a33bc15ab97fb270d5e6932ddc774948a7dc18188 -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
...
<!-- huiali-source: skills/rust-async-pattern/SKILL_EN.md#rust-block-2; sha256=5a6920d05eda8e42d7b5cf164f4745b1821642702e10e13e56952c4a8e23ab34 -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
use tokio::sync::mpsc;
...
<!-- huiali-source: skills/rust-async-pattern/SKILL_EN.md#rust-block-3; sha256=33b4dc5dc4510bfba022c664d2ec091cf01d1e1b17ec6d33df5099f4fce68983 -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
use tokio::select;
...
<!-- huiali-source: skills/rust-async-pattern/SKILL_ZH.md#rust-block-1; sha256=4d35934177ee2dc38e3041ff0f8a300037abfad7d28fdbc82e7d0198d4e40a52 -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
...
<!-- huiali-source: skills/rust-async-pattern/SKILL_ZH.md#rust-block-2; sha256=022a9dc8539de9a93e685976732da948f5e3147733c95b36529bab0d9aec1f47 -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
...
<!-- huiali-source: skills/rust-async-pattern/SKILL_ZH.md#rust-block-3; sha256=61724fbdc2ac0d4b8f9a7bccdbf2754b6d207156ebe730650bf3e1940ea09367 -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
...
<!-- huiali-source: skills/rust-async-pattern/SKILL_ZH.md#rust-block-4; sha256=9508983e1ab121640dd8d687ad49204c2cd5c3b2ac00f12f79fbe6f64a0791c3 -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
...
<!-- huiali-source: skills/rust-async-pattern/SKILL_ZH.md#rust-block-5; sha256=c43ba61bae8e67eb3fad4a133c3eb008f3c710271a004d76e68f40e3d7ab4f5d -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
// 1. 缓冲区管理域
struct MessageArena {
