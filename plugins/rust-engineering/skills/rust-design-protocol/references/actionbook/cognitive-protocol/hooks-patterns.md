...
> Product adaptation: Conceptual checkpoint catalog only. Product automation remains the existing fast read-only SessionStart router; pre/post-tool, stateful, periodic, and mutating source hooks are not installed.
