...
> Product adaptation: Optional synthesis protocol only when work was actually delegated. Do not enable negotiation universally or create agent fan-out solely to use this format.
