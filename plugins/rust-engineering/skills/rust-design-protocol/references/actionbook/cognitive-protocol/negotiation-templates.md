...
> Product adaptation: Optional evidence envelope, not a mandatory agent response schema. Use the smallest fields needed to preserve findings, gaps, sources, and confidence.
