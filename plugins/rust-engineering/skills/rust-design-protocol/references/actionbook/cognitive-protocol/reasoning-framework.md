...
> Product adaptation: Retained trace directions and reboot questions. Return concise decision rationale and evidence, never a private chain-of-thought transcript.
...
| [Actionbook eval corpus](../../../../../evals/actionbook-cases.json) | Evidence-based routing and negative cases |
| [Product Actionbook index](../../actionbook-index.md) | Meta-question and cognitive branches |

### Router

| File | Purpose |
|------|---------|
| [Adapted Actionbook router](../rust-router/overview.md) | Source routing logic under product precedence |
