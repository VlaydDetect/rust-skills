...
> Product adaptation: retained worked source example, not a universal prescription. Confirm the actual domain requirement before moving beyond Layer 1; Arc, clone, and the assumed fintech audit constraint are alternatives to evaluate, not defaults. Return decision evidence, not private chain-of-thought.
