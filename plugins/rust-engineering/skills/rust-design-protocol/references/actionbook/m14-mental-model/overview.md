...
> Adapted from Actionbook `m14-mental-model`. Use analogies to illuminate a verified rule, never as a substitute for the actual ownership, type, memory, or concurrency invariant.
...
| Advanced | Concurrency, unsafe | rust-concurrency, rust-unsafe |
