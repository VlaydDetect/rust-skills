...
> Adapted from Actionbook's OS-Checker integration. Use only tools already present in the project or explicitly approved; these names are options, not plugin dependencies.
