...
> Use as a read-only mechanics lens. It is normally applied inline by the owning profile; do not launch a separate agent unless its question is independent and high value.
