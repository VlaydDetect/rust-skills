...
> The three-strike model is an escalation heuristic, not permission to retry blindly. Escalate immediately when evidence changes the layer or authority is missing.
