...
> Use task artifacts only for long, inspectable work and only within authorized scope. Record decisions, evidence, attempts, and status, not private reasoning traces; no fixed two-action write cadence.
