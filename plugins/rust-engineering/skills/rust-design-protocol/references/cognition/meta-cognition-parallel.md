...
> The three layers are analysis lenses, not a requirement to launch three agents. Parallel read-only work is reserved for independent, high-value questions.
