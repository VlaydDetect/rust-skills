...
> Retained trace directions and reboot questions. Return concise decision rationale and evidence, never a private chain-of-thought transcript.
...
Include the decision rationale in the answer: state the relevant constraints, trade-off, and evidence without exposing private chain-of-thought.
...
3. **Answer with decision rationale** showing the relevant WHY, constraints, and evidence
...
| [negotiation-protocol.md](../negotiation/negotiation-protocol.md) | Agent communication protocol |
...
| File | Purpose |
|------|---------|
| [Product routing index](../../../rust-workflow/references/routing-index.md) | Complete owner catalog and conflict rules |
| [Design protocol eval suite](../../../../evals/evals.json) | Evidence-based routing and negative cases |
| [Product Design protocol index](../design-brief.md) | Meta-question and cognitive branches |

### Router

| File | Purpose |
|------|---------|
| [Decision router](../routing/router.md) | Source routing logic under product precedence |
