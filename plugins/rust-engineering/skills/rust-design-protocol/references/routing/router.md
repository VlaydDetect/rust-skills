...
> `rust-workflow` remains the automatic entrypoint. This reference supplies a cognitive routing model, not an all-Rust keyword hook or a requirement to expose private reasoning.
