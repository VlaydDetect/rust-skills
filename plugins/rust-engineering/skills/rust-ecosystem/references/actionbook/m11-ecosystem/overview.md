...
> Adapted from Actionbook `m11-ecosystem`. Dependency facts must come from effective Cargo metadata or current primary sources; nothing is auto-injected by a hook.
