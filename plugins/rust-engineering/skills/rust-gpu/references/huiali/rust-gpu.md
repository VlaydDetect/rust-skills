...
> Product adaptation of `skills/rust-gpu/SKILL.md` at revision `947bf77509d9b421035037e983da6662d08cbb8e`. The source workflow is retained below; product routing and current-project constraints override source-wide preferences.
...
<!-- huiali-source: skills/rust-gpu/SKILL.md#rust-block-1; sha256=c64fc380bbdf838d5c0decfa81d41d3a872cc91d5bbec6bccded68790454c049 -->
...
<!-- huiali-source: skills/rust-gpu/SKILL.md#rust-block-2; sha256=257bc18ab4c09a63672dfba18c71b7f558a79a6f67d300052c7cfc1759fad426 -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
// 零拷贝：共享主机和设备内存
...
<!-- huiali-source: skills/rust-gpu/SKILL.md#rust-block-3; sha256=318f2f5da1d62703dc6e60c54aa57c03b2010266fcd4c5411193c270668eaa77 -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
...
<!-- huiali-source: skills/rust-gpu/SKILL.md#rust-block-4; sha256=d79c1cbbf008643f9f024035a75abd100f7f817063329c73a6f4fc24908fa04b -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
// 合并访问模式 - 优化全局内存带宽
// ❌ 错误：非合并访问
...
<!-- huiali-source: skills/rust-gpu/SKILL.md#rust-block-5; sha256=b3ec961c65eecdc9b002443f8d5630e7c64310c9cb26d808466937e217ffb3d3 -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
// 使用共享内存减少全局内存访问
...
<!-- huiali-source: skills/rust-gpu/SKILL.md#rust-block-6; sha256=b1c3deb9fac860e5e6096785ffd35b28f04c5100a200638906116805583e767f -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
// 内存对齐优化
