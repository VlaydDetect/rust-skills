...
This guide is the detailed policy for `rust-lombok-macros`. It synthesizes the full-stack Lombok-macros specialization and its constructor, accessor, builder, validation, diagnostics, and testing references; it is adapted for a dual-host workflow rather than copied as an upstream transcript.
