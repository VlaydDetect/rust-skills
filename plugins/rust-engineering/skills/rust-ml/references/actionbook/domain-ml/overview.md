...
> Adapted from Actionbook `domain-ml`. Crate and backend examples are candidates whose current versions, devices, licenses, and deployment constraints require fresh verification.
