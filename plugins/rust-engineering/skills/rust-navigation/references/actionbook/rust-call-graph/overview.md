...
> Adapted from Actionbook `rust-call-graph`. Use host-native call hierarchy when available and label trait, function-pointer, macro-generated, and dynamic-dispatch edges by confidence.
