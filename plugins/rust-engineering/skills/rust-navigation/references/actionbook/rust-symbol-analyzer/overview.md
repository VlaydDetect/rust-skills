...
> Adapted from Actionbook `rust-symbol-analyzer`. LSP symbols are preferred when the host exposes them; Graphify and source search are supported fallbacks whose edges require confirmation.
