...
> Adapted from Actionbook `rust-trait-explorer`. Account for blanket impls, cfg, proc macros, coherence, receiver types, and dyn dispatch; textual matches are candidates rather than proof.
