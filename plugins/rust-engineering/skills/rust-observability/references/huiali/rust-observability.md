# Huiali Observability Protocol

> Product adaptation of `skills/rust-observability/SKILL.md` at revision `947bf77509d9b421035037e983da6662d08cbb8e`. The source workflow is retained below; product routing and current-project constraints override source-wide preferences.
