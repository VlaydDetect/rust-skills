...
> Adapted from Actionbook `m03-mutability`. Preserve the smallest sound mutability surface and choose synchronization only from demonstrated sharing requirements.
