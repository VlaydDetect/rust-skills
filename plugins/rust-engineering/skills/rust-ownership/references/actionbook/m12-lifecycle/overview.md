...
> Adapted from Actionbook `m12-lifecycle`. Model acquisition, steady state, failure, cancellation, shutdown, and drop explicitly before choosing helpers or crates.
