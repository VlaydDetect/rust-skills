# Huiali Linear Type Protocol

> Product adaptation of `skills/rust-linear-type/SKILL.md` at revision `947bf77509d9b421035037e983da6662d08cbb8e`. The source workflow is retained below; product routing and current-project constraints override source-wide preferences.
...
<!-- huiali-source: skills/rust-linear-type/SKILL.md#rust-block-1; sha256=caba16f05f1b320434f09b5e451e9dc9c3f30746892872f7b4cddba3f4a7863c -->
...
<!-- huiali-source: skills/rust-linear-type/SKILL.md#rust-block-2; sha256=10f322321727f2819b87aa761419ab9cae7aa654f45fdc520759b3b6c9048922 -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
// 确保对象只能被移动，不能被复制
#[derive(Copy, Clone)]
...
<!-- huiali-source: skills/rust-linear-type/SKILL.md#rust-block-3; sha256=f06ee53c7782b979d345d74579225e67ef59c5781651711eb0adc9e226ee0d61 -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
// 线性资源令牌
...
<!-- huiali-source: skills/rust-linear-type/SKILL.md#rust-block-4; sha256=120057f5e6c48c575355e08f34e6fd56b159880b8bec693651f2b791fb8cbfc2 -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
// 两阶段提交模式
...
<!-- huiali-source: skills/rust-linear-type/SKILL.md#rust-block-5; sha256=0bd485132416916265fa992427602cfcb4ee9eb20f893cbae394410344b795da -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
