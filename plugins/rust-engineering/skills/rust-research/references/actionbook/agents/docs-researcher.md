...
> Adapted into `rust-researcher`. Use version-specific docs and no persistent home-directory cache.
...
- normal host web access or locally available package rustdoc/source

**URL format:** `docs.rs/<crate>/latest/<crate>/<path>`

## Cache

Record retrieval metadata in the current result or an explicitly requested project-local dossier.
TTL: 7 days
