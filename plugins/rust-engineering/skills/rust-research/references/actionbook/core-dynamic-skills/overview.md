...
> Adapted from Actionbook `core-dynamic-skills`. Project-local dossiers are canonical; Codex and Claude wrappers are optional explicit exports. No session hook parses manifests, fetches documentation, or writes skills.
