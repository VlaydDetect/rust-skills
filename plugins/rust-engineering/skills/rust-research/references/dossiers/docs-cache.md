...
Design protocol's persistent Claude documentation cache is not reproduced. Keep evidence in the current research result or an explicitly requested project-local crate dossier.
