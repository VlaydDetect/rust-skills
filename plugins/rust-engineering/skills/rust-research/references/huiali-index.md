# Huiali references for `rust-research`
...
- [`rust-learner`](huiali/rust-learner.md) — primary; Current-feature adoption, MSRV and Edition evidence, release-note research, feedback, and dependency-ordered practice.
