# Huiali Learner Protocol

> Product adaptation of `skills/rust-learner/SKILL.md` at revision `947bf77509d9b421035037e983da6662d08cbb8e`. The source workflow is retained below; product routing and current-project constraints override source-wide preferences.

## Product routing and baseline

- Primary owner: `$rust-research`.
- Supporting profiles when needed: `$rust-by-example`, `$rust-stable`.
- Scope retained: Current-feature adoption, MSRV and Edition evidence, release-note research, feedback, and dependency-ordered practice.
- Baseline correction: Date current claims and prefer official Rust and exact-version crate sources. Learning guidance does not authorize an MSRV, Edition, dependency, or lockfile upgrade.
...
<!-- huiali-source: skills/rust-learner/SKILL.md#rust-block-1; sha256=2ca3ea34f636397ae8033dc705de2ced40d3f5158d811e308f6d2f446340b40a -->
