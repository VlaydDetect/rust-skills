...
> The `rust-researcher` role Match lint documentation to the applicable toolchain and inspect the project's configured lint levels before recommending policy.
