...
> Current facts use primary sources and dated evidence. Design protocol MCP selectors, agent-browser, and background agents are optional host capabilities, not dependencies or mandatory tool order.
