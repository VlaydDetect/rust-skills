...
> News research runs only on an explicit daily, weekly, or monthly request. It has no automatic fetch, persistent news cache, or scheduled background process.
