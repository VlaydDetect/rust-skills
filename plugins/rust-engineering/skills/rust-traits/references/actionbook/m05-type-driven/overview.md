...
> Adapted from Actionbook `m05-type-driven`. Encode stable invariants in types only when the additional states, generics, and diagnostics improve the real API.
