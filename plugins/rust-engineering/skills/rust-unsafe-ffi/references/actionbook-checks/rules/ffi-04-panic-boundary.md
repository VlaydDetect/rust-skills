...
> Product adaptation for `ffi-04`: Choose catch_unwind, abort, or C-unwind from the exact ABI and panic strategy. C-unwind is not a blanket license to unwind through arbitrary foreign frames; Rust 2024 exported attributes are unsafe attributes.
>
