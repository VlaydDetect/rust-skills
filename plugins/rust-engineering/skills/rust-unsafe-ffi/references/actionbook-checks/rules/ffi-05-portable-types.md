...
> Product adaptation for `ffi-05`: Prefer generated bindings or header-derived c_* aliases. Do not assume usize is every platform size_t or pointer-sized integer ABI merely from width.
>
