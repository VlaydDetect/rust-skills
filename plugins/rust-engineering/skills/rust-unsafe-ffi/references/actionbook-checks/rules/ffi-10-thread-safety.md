...
> Product adaptation for `ffi-10`: An exported API may be thread-safe, thread-affine, externally synchronized, or single-threaded. Document and enforce the chosen contract instead of adding synchronization universally.
>
