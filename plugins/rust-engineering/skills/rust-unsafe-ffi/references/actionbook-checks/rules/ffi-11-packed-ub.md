...
> Product adaptation for `ffi-11`: Prefer copying packed fields by value or addr_of plus unaligned operations, and verify current compiler diagnostics; do not infer that every expression necessarily creates a reference.
>
