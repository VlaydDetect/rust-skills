...
> Product adaptation for `ffi-14`: Do not expose Rust collection ownership by ptr-len-cap without a paired Rust destructor and versioned contract. Rust niche guarantees are not automatically a convenient C source representation.
>
