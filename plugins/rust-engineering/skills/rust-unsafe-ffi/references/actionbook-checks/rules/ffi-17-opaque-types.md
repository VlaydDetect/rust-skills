...
> Product adaptation for `ffi-17`: Dedicated opaque types improve handle separation only when they match the foreign header. Specify ownership and Send or Sync behavior explicitly; marker fields alone do not prove the ABI contract.
>
