...
> Product adaptation for `ffi-18`: A manual vtable must be monomorphic for its payload, versioned, and pair each method and destructor with the exact allocation type. The retained generic static-vtable example is rejected.
>
