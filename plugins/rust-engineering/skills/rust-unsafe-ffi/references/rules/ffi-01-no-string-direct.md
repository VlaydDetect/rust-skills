...
> Rule refinement for `ffi-01`: Do not assume every foreign string is nul-terminated C text; the contract may be pointer plus length, UTF-16, or another encoding. Choose CString or CStr only when that ABI requires it.
>
