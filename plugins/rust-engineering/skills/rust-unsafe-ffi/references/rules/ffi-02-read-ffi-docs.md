...
> Rule refinement for `ffi-02`: Select ffi types from the documented encoding, ownership, mutability, and lifetime contract; a non-null pointer still needs bounds and validity proof.
>
