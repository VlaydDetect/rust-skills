...
> Rule refinement for `ffi-03`: Implement Drop only for an owning wrapper and call the matching destructor. Do not use the retained non-auto negative impl example; simply omit Clone unless a real clone operation exists.
>
