...
> Rule refinement for `ffi-06`: CString::into_raw memory must be returned to CString::from_raw through a Rust-owned destroy function unless the allocator contract explicitly proves compatibility; an arbitrary C free is invalid.
>
