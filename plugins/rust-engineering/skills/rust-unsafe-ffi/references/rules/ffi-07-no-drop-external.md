...
> Rule refinement for `ffi-07`: Whether a type implements Drop depends on who owns the resource, not whether foreign code sees it. The retained ManuallyDrop stack-pointer transfer is rejected because the storage can dangle.
>
