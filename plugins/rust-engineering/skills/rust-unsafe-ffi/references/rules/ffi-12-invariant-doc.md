...
> Rule refinement for `ffi-12`: Documentation cannot make a safe Rust entry point sound when it trusts an arbitrary pointer. Validate what is observable and put unverifiable allocation, validity, and lifetime obligations on an unsafe boundary.
>
