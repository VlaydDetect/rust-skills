...
> Rule refinement for `ffi-13`: repr(C) must be checked against the actual header and target ABI, including enum representation, padding, and alignment. offset_of is available on modern stable toolchains; follow the project MSRV.
>
