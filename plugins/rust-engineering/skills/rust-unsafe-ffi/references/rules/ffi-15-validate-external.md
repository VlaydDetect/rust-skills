...
> Rule refinement for `ffi-15`: Null and length caps cannot prove that a pointer covers an allocation. Pointer extent, initialization, aliasing, and lifetime remain unsafe caller obligations.
>
