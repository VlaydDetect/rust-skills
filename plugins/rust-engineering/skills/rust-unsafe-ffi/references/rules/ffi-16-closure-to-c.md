...
> Rule refinement for `ffi-16`: A callback design must pin or otherwise stabilize context storage and define registration lifetime, concurrent calls, reentrancy, panic handling, and deregistration races. The retained examples are not sound templates.
>
