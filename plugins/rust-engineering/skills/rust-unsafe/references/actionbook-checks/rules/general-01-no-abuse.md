...
> Product adaptation for `general-01`: Treat safe alternatives as the first design step, but accept unsafe when the operation has a documented contract and local proof.
>
