...
> Product adaptation for `mem-01`: repr(C) and repr(transparent) provide specified guarantees under their exact constraints, not blanket permission to transmute; verify layout for every supported target and C header.
>
