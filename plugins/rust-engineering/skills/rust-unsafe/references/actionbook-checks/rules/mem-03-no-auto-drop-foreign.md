...
> Product adaptation for `mem-03`: Never fabricate a static borrow from a foreign pointer. Match the exact allocator and ownership-transfer contract or copy into Rust-owned storage.
>
