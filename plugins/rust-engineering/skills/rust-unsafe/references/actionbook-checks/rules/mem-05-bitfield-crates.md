...
> Product adaptation for `mem-05`: Use standard integer operations for simple bitfields. Add bitflags, bitvec, or a parser crate only when the format complexity and dependency policy justify it.
>
