...
> Product adaptation for `mem-06`: Zero is valid for bool; reject the source counterexample. Verify current MaybeUninit APIs and prove initialization, panic cleanup, and exactly-once drop before assume_init or set_len.
>
