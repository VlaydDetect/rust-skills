...
> Product adaptation for `ptr-01`: AtomicPtr synchronizes the pointer value, not the pointee lifetime or access. The source atomic example is insufficient without reclamation and aliasing proofs.
>
