...
> Product adaptation for `ptr-05`: Casting const to mut is not itself UB, but mutation through a pointer derived from shared access requires UnsafeCell or another valid provenance and exclusivity basis.
>
