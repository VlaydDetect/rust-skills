...
> Product adaptation for `ptr-06`: Prefer pointer methods for clarity, but verify the current strict-provenance API on the project toolchain; do not copy historical nightly or expose_addr names blindly.
>
