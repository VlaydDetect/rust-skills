...
> Product adaptation for `safety-02`: For Rust 2024, unsafe operations inside unsafe fn still need explicit unsafe blocks; caller obligations must be distinguished from locally checked facts.
>
