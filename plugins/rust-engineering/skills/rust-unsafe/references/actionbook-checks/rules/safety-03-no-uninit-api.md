...
> Product adaptation for `safety-03`: Ignore historical nightly labels and verify MaybeUninit and Box APIs against the project toolchain; initialization and partial-drop accounting remain mandatory.
>
