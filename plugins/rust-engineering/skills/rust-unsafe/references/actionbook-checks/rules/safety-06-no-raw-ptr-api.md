...
> Product adaptation for `safety-06`: Raw pointers in a public API are not automatically unsound, and returning as_ptr is normally safe; mark an API unsafe only when a Rust caller must uphold a safety precondition.
>
