...
> Product adaptation for `safety-07`: Do not add an unchecked counterpart by default. Add one only for a measured hot path with a stable caller contract and a maintained safe alternative.
>
