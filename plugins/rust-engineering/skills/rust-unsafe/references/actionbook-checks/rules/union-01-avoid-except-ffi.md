...
> Product adaptation for `union-01`: Reading a different union field is not automatically UB; soundness depends on the resulting type validity, provenance, lifetime, and active-field protocol. Prefer enums for ordinary variants.
>
