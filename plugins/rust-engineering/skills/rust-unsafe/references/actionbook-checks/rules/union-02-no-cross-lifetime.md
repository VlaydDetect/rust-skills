...
> Product adaptation for `union-02`: Equal lifetime parameters or similar-looking fat pointers do not establish representation compatibility. The retained str-to-byte-slice union example is rejected; use as_bytes.
>
