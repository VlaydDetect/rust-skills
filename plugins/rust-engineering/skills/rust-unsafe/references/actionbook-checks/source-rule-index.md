...
> Product adaptation: this is the retained upstream inventory. Follow
> [overview.md](overview.md) and the per-rule product note before applying any
> row. FFI files live under `rust-unsafe-ffi`; all other rule files live under
> this skill. Counts and IDs remain unchanged for traceability.

**Source-generated from rules; retained as provenance evidence.**
