# Huiali Unsafe Protocol

> Product adaptation of `skills/rust-unsafe/SKILL.md` at revision `947bf77509d9b421035037e983da6662d08cbb8e`. The source workflow is retained below; product routing and current-project constraints override source-wide preferences.

## Product routing and baseline

- Primary owner: `$rust-unsafe`.
- Supporting profiles when needed: `$rust-review`, `$rust-testing`.
- Scope retained: Unsafe preconditions, aliasing, initialization, layout, provenance, Send/Sync, panic safety, and safe-abstraction review.
- Baseline correction: Minimize unsafe surface and write a local proof for every operation. Unsafe is not a default performance technique, and comments must name the invariant evidence rather than restate the operation.
...
<!-- huiali-source: skills/rust-unsafe/SKILL.md#rust-block-1; sha256=5dd699b0eb5408db1343495fcb6c5ed4ce957ef2c2955c4d93cfa25a2611b6a2 -->
...
<!-- huiali-source: skills/rust-unsafe/SKILL.md#rust-block-2; sha256=e9ad41692e5b8cb3e7bbea44cd6bb4c47cafa8a4f35e1611f65d323ab7963966 -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
...
<!-- huiali-source: skills/rust-unsafe/SKILL.md#rust-block-3; sha256=6b43c03472114076d895a80e3787741462987b92ae78ffc186f67dfaf04db250 -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
use std::ptr::NonNull;
...
<!-- huiali-source: skills/rust-unsafe/SKILL.md#rust-block-4; sha256=c524a82e3d0b37e823f1b1323106442472e2d965d2b3acf0cde060de24f68b01 -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
...
<!-- huiali-source: skills/rust-unsafe/SKILL.md#rust-block-5; sha256=8dcb5e28b230bfe1ea6b82b8b40757544a5d8c849a2dff268b16152a70cc2816 -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
#[repr(C)]
pub struct Point {
...
<!-- huiali-source: skills/rust-unsafe/SKILL.md#rust-block-6; sha256=5865ee93f6d4318d8608a0ea99ce89a1981dada23675d73e1c951ab9caaa3bf4 -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
...
<!-- huiali-source: skills/rust-unsafe/SKILL.md#rust-block-7; sha256=fa8969eec1d6c062092e801896883426a7bd27f0658db3e81077af795f14ca17 -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
...
<!-- huiali-source: skills/rust-unsafe/SKILL.md#rust-block-8; sha256=4d73f2830ee0fb44bf1f0edbca9a9c351032224c1af84ddf0e5fa0bfa1a018c6 -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
...
<!-- huiali-source: skills/rust-unsafe/SKILL_EN.md#rust-block-1; sha256=267e95a1c199c2c797b63a8f11bb4e1dcf772edbb5a8d97d0628d98e4babbb0e -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
...
<!-- huiali-source: skills/rust-unsafe/SKILL_ZH.md#rust-block-1; sha256=fa0c1fd549368400dc6e0afc29b403f66303d975b95ce464fefab1c3a4608b15 -->
<!-- rust-example: fragment; missing: surrounding project types, dependencies, target, and verification harness -->
```rust
// SAFETY: ptr must be non-null and properly aligned.
// This function is only called after a null check.
