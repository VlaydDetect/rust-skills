...
- [`custom-allocators`](low-level/custom-allocators.md) — primary; Pool, arena, global and system allocators, ownership, alignment, fragmentation, concurrency, teardown, and benchmarking.
...
- [`rust-sanitizers-miri`](low-level/rust-sanitizers-miri.md) — primary; Miri and Rust sanitizer selection, execution scope, report interpretation, unsafe-code validation, and residual proof obligations.
...
- [`sanitizers`](low-level/sanitizers.md) — primary; ASan, TSan, MSan, hardware-assisted modes, suppression and report concepts, and native dependency instrumentation.
