...
> Rule refinement for `general-03`: Names are review signals, not a soundness mechanism; an ordinary safe-wrapper name is fine only when the wrapper enforces every precondition.
>
