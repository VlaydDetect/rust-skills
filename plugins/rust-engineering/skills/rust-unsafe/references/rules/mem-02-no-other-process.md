...
> Rule refinement for `mem-02`: Cross-process memory can be legitimate for debuggers or declared shared-memory protocols. Require authorization plus OS, ownership, synchronization, and lifetime contracts.
>
