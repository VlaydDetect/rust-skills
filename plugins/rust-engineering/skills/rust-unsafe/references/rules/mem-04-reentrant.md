...
> Rule refinement for `mem-04`: Reentrant APIs are platform- and function-specific; some _r APIs such as readdir_r are obsolete. Prefer the standard library when it matches semantics, otherwise follow the target API contract.
>
