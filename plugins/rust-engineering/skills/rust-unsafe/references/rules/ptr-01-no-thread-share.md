...
> Rule refinement for `ptr-01`: AtomicPtr synchronizes the pointer value, not the pointee lifetime or access. The atomic example is insufficient without reclamation and aliasing proofs.
>
