...
> Rule refinement for `ptr-02`: NonNull proves only non-nullness; validity, alignment, initialization, ownership, aliasing, and appropriate variance still require separate proof.
>
