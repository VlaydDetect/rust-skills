...
> Rule refinement for `safety-01`: Analyze the project panic strategy and every unwind or abort path; illustrative MyVec fragments are not standalone implementations.
>
