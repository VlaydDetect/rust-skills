...
> Rule refinement for `safety-05`: Manual Send or Sync requires a proof covering pointee access, destruction, aliasing, and the foreign or OS contract, not merely atomic reference counting.
>
