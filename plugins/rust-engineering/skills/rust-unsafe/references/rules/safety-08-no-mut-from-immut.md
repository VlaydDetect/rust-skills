...
> Rule refinement for `safety-08`: UnsafeCell is necessary for mutation through shared access but never sufficient; a safe API must enforce exclusive access with a guard, state machine, or equivalent proof.
>
