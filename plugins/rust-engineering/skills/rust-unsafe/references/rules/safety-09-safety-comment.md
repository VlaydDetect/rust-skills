...
> Rule refinement for `safety-09`: A SAFETY comment must cite established facts. A safe function cannot delegate an unchecked index or pointer obligation to its caller.
>
