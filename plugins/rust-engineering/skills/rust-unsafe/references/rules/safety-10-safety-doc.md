...
> Rule refinement for `safety-10`: Use a # Safety section for public unsafe APIs and the repository lint policy; examples remain fragments until compiled in their defining crate.
>
