...
> Rule refinement for `safety-11`: Assertions can turn a checked precondition into a safe path, but debug assertions do not discharge release-build obligations and assertions never replace an unsafe contract proof.
>
