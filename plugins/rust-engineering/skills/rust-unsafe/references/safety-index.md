# Design protocol internal unsafe rule index

Load only the rules relevant to the operation under review. Each retained file
contains the full rationale and examples plus a local correction note
...
Use these established product rules alongside the Design protocol prompt; do not
...
See [the complete retained inventory](./guide.md),
[review protocol](./safety-overview.md), and [review checklist](./checklists/review-unsafe.md).
