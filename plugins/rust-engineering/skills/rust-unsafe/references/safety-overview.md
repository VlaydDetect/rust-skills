# Design protocol unsafe review protocol

This directory adapts Design protocol's 47-rule unsafe checker into the product's
...
4. Relevant Design protocol rule IDs as adversarial review prompts.
...
- [Internal unsafe index](./safety-index.md): `general-*`, `safety-*`, `ptr-*`,
  `union-*`, `mem-*`, and `io-*` (29 rules).
- [FFI index](../../rust-unsafe-ffi/references/ffi-rule-index.md):
  `ffi-*` (18 rules).
- [Before writing unsafe](./checklists/before-unsafe.md), [review checklist](./checklists/review-unsafe.md),
  ...
  pass/fail gates.
- [Source rule template](./guide.md) and
  [source metadata](./guide.md) preserve upstream structure and
